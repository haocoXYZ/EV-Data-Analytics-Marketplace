...
BEGIN
    PRINT '--- User (sample) ---';
    SELECT TOP 5 * FROM [User] ORDER BY CreatedAt DESC;
    PRINT '';
END
...
BEGIN
    ...
    SELECT TOP 5 * FROM DataProvider ORDER BY RegistrationDate DESC;
    PRINT '';
END
...
BEGIN
    ...
    SELECT TOP 5 * FROM DataConsumer ORDER BY RegistrationDate DESC;
    PRINT '';
END
...
BEGIN
    PRINT '--- Dataset ---';
    SELECT * FROM Dataset ORDER BY UploadDate DESC;
    PRINT '';
END
...
BEGIN
    ...
    SELECT * FROM DatasetModeration ORDER BY ReviewDate DESC;
    PRINT '';
END
...
BEGIN
    ...
    SELECT * FROM DataPackagePurchase ORDER BY PurchaseDate DESC;
    PRINT '';
END
...
BEGIN
    ...
    SELECT * FROM OneTimePurchase ORDER BY PurchaseDate DESC;
    PRINT '';
END
...
BEGIN
    ...
    SELECT * FROM SubscriptionPackagePurchase ORDER BY PurchaseDate DESC;
    PRINT '';
END
...
BEGIN
    PRINT '--- Subscription ---';
    SELECT * FROM Subscription ORDER BY StartDate DESC;
    PRINT '';
END
...
BEGIN
    ...
    SELECT * FROM APIPackagePurchase ORDER BY PurchaseDate DESC;
    PRINT '';
END
...
BEGIN
    ...
    SELECT TOP 10 * FROM Payment ORDER BY PaymentDate DESC;
    PRINT '';
END
...
BEGIN
    PRINT '--- Payout ---';
    SELECT * FROM Payout ORDER BY PayoutDate DESC;
    PRINT '';
END
...
BEGIN
    PRINT '--- RevenueShare ---';
    SELECT * FROM RevenueShare ORDER BY ShareDate DESC;
    PRINT '';
END
